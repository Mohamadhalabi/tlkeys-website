<template>
  <nav
    class="sticky z-40 border-b border-gray-200 text-gray-900 supports-[backdrop-filter]:bg-white/80 backdrop-blur-sm"
...
const isActive = (item: any) => {
  ...
  const normalizedRoute = localePath(item.to.split('?')[0])
  return route.path === normalizedRoute
}
