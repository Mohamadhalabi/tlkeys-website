        ...
        <div class="p-6">
          <form @submit.prevent="submit" class="space-y-5">
            <p class="text-gray-800">
              {{ t('forgot.subText', 'Lost your password? Please enter your email address. You will receive a link to create a new password via email.') }}
            </p>
            ...
            <div class="flex items-center justify-between">
              ...
              <button
                ...
                {{ loading ? t('forgot.sending', 'Sending…') : t('forgot.resetCta', 'Reset Password') }}
              </button>
            </div>
