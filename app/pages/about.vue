...
import { useI18n, useNuxtApp, useRuntimeConfig } from '#imports'
...
const categories = computed(() => ([
  { title: t('home.categories.carRemotes'),            href: '/car-remotes',    image: '/images/home/categories/car-remotes.webp' },
  { title: t('home.categories.xhorseRemotes'),         href: '/xhorse-remotes', image: '/images/home/categories/xhorse-remote.webp' },
  { title: t('home.categories.keydiyRemotes'),         href: '/keydiy-remotes', image: '/images/home/categories/keydiy-kd-remote.webp' },
  { title: t('home.categories.remotePcb'),             href: '/remote-pcb',     image: '/images/home/categories/pcb-remote.webp' },

  { title: t('home.categories.keyProgrammingDevices'), href: '/key-programming-diagnostics-tools', image: 'https://dev-srv.tlkeys.com/storage/images/main-menu/devices-and-machines/devices%20and%20machine.jpg' },
  { title: t('home.categories.keyCuttingMachines'),    href: '/key-cutting-machine',               image: 'https://dev-srv.tlkeys.com/storage/images/main-menu/devices-and-machines/key%20cutting%20machines.jpg' },
  { title: t('home.categories.cables'),                href: '/cables',                            image: 'https://dev-srv.tlkeys.com/storage/images/main-menu/devices-and-machines/cables%202.jpg' },
  { title: t('home.categories.adapter'),               href: '/adapter',                           image: 'https://dev-srv.tlkeys.com/storage/images/main-menu/devices-and-machines/adapers.jpg' },

  { title: t('home.categories.cutter'),                href: '/cutter',                            image: 'https://dev-srv.tlkeys.com/storage/images/main-menu/accessories-tools/1698760907-Cutter.jpg' },
  { title: t('home.categories.emulators'),             href: '/emulators',                         image: 'https://dev-srv.tlkeys.com/storage/images/main-menu/devices-and-machines/emulators.jpg' },
  { title: t('home.categories.openingTools'),          href: '/opening-tools',                     image: 'https://dev-srv.tlkeys.com/storage/images/main-menu/accessories-tools/opening%20tools.jpg' },
  { title: t('home.categories.immobilizerSmartBox'),   href: '/immobilizer-smart-box',             image: 'https://dev-srv.tlkeys.com/storage/images/main-menu/accessories-tools/immobilizer-smart-box.jpg' },
]))
const catRows = computed(() => Math.ceil((categories.value?.length || 0) / 5))
